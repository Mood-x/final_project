...
public class CompetitionService {
    ...
    public List<Competition> searchCompetitionsByDateRange(LocalDate startDate, LocalDate endDate){
        return competitionRepository.findAllByDateBetween(startDate, endDate)
                .orElseThrow(() -> new ApiException("Not found competitions between this date"));
    }
    ...
    public List<Competition> searchCompetitionsByType(String type){
        return competitionRepository.findAllByType(type)
                .orElseThrow(() -> new ApiException("Not found competitions by this type"));
    }

    public List<Competition> searchCompetitionsByAgeRange(Integer ageFrom, Integer ageTo){
        return competitionRepository.findCompetitionsByAgeRange(ageFrom, ageTo)
                .orElseThrow(() -> new ApiException("Not found competitions by this age range"));
    }
